...
$(function () {
  $('.incrementer, .decrementer').click(function () {
    ...
    var Bed = '';
    var Bathroom = '';
    var InputTextFacilities = '';

    if (Number(counter4.val()) == 1) {
      Bedroom = ' спальня, ';
    } else if (Number(counter4.val()) >= 2 && Number(counter4.val()) <= 4) {
      Bedroom = ' спальни, ';
    } else if (Number(counter4.val()) == 0 || Number(counter4.val()) >= 5) {
      Bedroom = ' спален, ';
    }

    if (Number(counter5.val()) == 1) {
      Bed = ' кровать, ';
    } else if (Number(counter5.val()) >= 2 && Number(counter5.val()) <= 4) {
      Bed = ' кровати, ';
    } else if (Number(counter5.val()) == 0 || Number(counter5.val()) >= 5) {
      Bed = ' кроватей, ';
    }

    if (Number(counter6.val()) == 1) {
      Bathroom = ' ванная комната, ';
    } else if (Number(counter6.val()) >= 2 && Number(counter6.val()) <= 4) {
      Bathroom = ' ванные комнаты, ';
    } else if (Number(counter6.val()) == 0 || Number(counter6.val()) >= 5) {
...
},{}]},{},["../../Users/alexi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/blocks/dropdown-facilities/dropdown-facilities.js"], null)
//# sourceMappingURL=/dropdown-facilities.3015f2b2.js.map