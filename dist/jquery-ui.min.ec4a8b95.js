...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/blocks/range-slider/jquery-ui-1.12.1.custom/jquery-ui.min.js":[function(require,module,exports) {
var define;
...
(function (t) {
  ...
  t.cleanData = function (e) {
    ...
    for (var i, s, o = n.call(arguments, 1), a = 0, r = o.length; r > a; a++) {
      for (i in o[a]) {
        s = o[a][i], o[a].hasOwnProperty(i) && void 0 !== s && (e[i] = t.isPlainObject(s) ? t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s) : s);
      }
    }
    ...
    t.position = {
      ...
      }), 1 === w.length && (w[1] = w[0]), "right" === n.at[0] ? g.left += p : "center" === n.at[0] && (g.left += p / 2), "bottom" === n.at[1] ? g.top += f : "center" === n.at[1] && (g.top += f / 2), u = e(k.at, p, f), g.left += u[0], g.top += u[1], this.each(function () {
        var s,
            r,
            l = t(this),
            h = l.outerWidth(),
  ...
  t(document).on("mouseup", function () {
    ...
    _drop: function _drop(e, i) {
      ...
      return s && (s.currentItem || s.element)[0] !== this.element[0] ? (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
        ...
        return i.options.greedy && !i.options.disabled && i.options.scope === s.options.scope && i.accept.call(i.element[0], s.currentItem || s.element) && a(s, t.extend(i, {
  ...
  t.ui.ddmanager = {
    ...
    drop: function drop(e, i) {
      ...
      return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function () {
        this.options && (!this.options.disabled && this.visible && a(e, this, this.options.tolerance, i) && (s = this._drop.call(this, i) || s), !this.options.disabled && this.visible && this.accept.call(this.element[0], e.currentItem || e.element) && (this.isout = !0, this.isover = !1, this._deactivate.call(this, i)));
      }), s;
    },
      ...
      e.options.refreshPositions && t.ui.ddmanager.prepareOffsets(e, i), t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
        if (!this.options.disabled && !this.greedyChild && this.visible) {
          var s,
              n,
              o,
              r = a(e, this, this.options.tolerance, i),
              l = !r && this.isover ? "isout" : r && !this.isover ? "isover" : null;
          l && (this.options.greedy && (n = this.options.scope, o = this.element.parents(":data(ui-droppable)").filter(function () {
            return t(this).droppable("instance").options.scope === n;
          }), o.length && (s = t(o[0]).droppable("instance"), s.greedyChild = "isover" === l)), s && "isover" === l && (s.isover = !1, s.isout = !0, s._out.call(s, i)), this[l] = !0, this["isout" === l ? "isover" : "isout"] = !1, this["isover" === l ? "_over" : "_out"].call(this, i), s && "isout" === l && (s.isout = !1, s.isover = !0, s._over.call(s, i)));
        }
      });
    },
  ...
  t.widget("ui.controlgroup", {
    ...
    _resolveClassesValues: function _resolveClassesValues(e, i) {
      ...
      return t.each(e, function (n) {
        ...
        o = t.trim(o.replace(r, "")), s[n] = (o + " " + e[n]).replace(/\s+/g, " ");
      }), s;
    },
    _setOption: function _setOption(t, e) {
    ...
    value: function value(t) {
      return arguments.length ? (i(this._value).call(this, t), void 0) : this._parse(this.element.val());
    },
    widget: function widget() {
  ...
  t.effects.define("blind", "hide", function (e, i) {
    ...
    for (t.effects.createPlaceholder(a), o = a.css(g), u || (u = a["top" === g ? "outerHeight" : "outerWidth"]() / 3), h && (n = {
      opacity: 1
    }, n[g] = o, a.css("opacity", 0).css(g, v ? 2 * -u : 2 * u).animate(n, f, m)), l && (u /= Math.pow(2, d - 1)), n = {}, n[g] = o; d > _; _++) {
      s = {}, s[g] = (v ? "-=" : "+=") + u, a.animate(s, f, m).animate(n, f, m), u = l ? 2 * u : u / 2;
    }
    ...
    for (o = 0; u > o; o++) {
      for (l = g.top + o * _, c = o - (u - 1) / 2, a = 0; d > a; a++) {
        r = g.left + a * v, h = a - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
          position: "absolute",
          visibility: "visible",
          left: -a * v,
          top: -o * _
  ...
  var d;
  t.uiBackCompat !== !1 && (d = t.effects.define("transfer", function (e, i) {
    t(this).transfer(e, i);
  }));
});
...
},{}]},{},["../../Users/alexi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/blocks/range-slider/jquery-ui-1.12.1.custom/jquery-ui.min.js"], null)
//# sourceMappingURL=/jquery-ui.min.ec4a8b95.js.map