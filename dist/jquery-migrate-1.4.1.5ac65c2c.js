...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/template/jquery-migrate-1.4.1.js":[function(require,module,exports) {
/*!
...
(function (jQuery, window, undefined) {
  ...
  rquickExpr = /^([^<]*)(<[\w\W]+>)([^>]*)$/; // $(html) "looks like html" rule change
  ...
  jQuery.fn.init = function (selector, context, rootjQuery) {
    ...
    ret = oldInit.apply(this, arguments); // Fill in selector and context properties so .live() works
  ...
  migrateWarnProp(jQuery, "browser", jQuery.browser, "jQuery.browser is deprecated"); // jQuery.boxModel deprecated in 1.3, jQuery.support.boxModel deprecated in 1.7
  ...
  var rscriptType = /\/(java|ecma)script/i; // Since jQuery.clean is used internally on older versions, we only shim if it's missing
...
},{}]},{},["../../Users/alexi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pages/template/jquery-migrate-1.4.1.js"], null)
//# sourceMappingURL=/jquery-migrate-1.4.1.5ac65c2c.js.map